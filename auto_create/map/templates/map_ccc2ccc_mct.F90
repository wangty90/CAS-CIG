module map_{ccc}{ccc}_mct

!---------------------------------------------------------------------
!
! Purpose:
!
! Collect coupling routines for sequential coupling of {ccc}x - {ccc}{c}
!
! Author: T. Craig
!
!---------------------------------------------------------------------
...
!--------------------------------------------------------------------------
  ...
  public :: map_{ccc}2{ccc}_init_mct
  public :: map_{ccc}x2{ccc}{c}_mct
  public :: map_{ccc}{c}2{ccc}x_mct

  ! Note ccc is component, xxx is driver/coupler

  interface map_{ccc}2{ccc}_init_mct; module procedure &
    map_ccc2ccc_init_mct
  end interface
  interface map_{ccc}x2{ccc}{c}_mct; module procedure &
    map_xxx2ccc_mct
  end interface
  interface map_{ccc}{c}2{ccc}x_mct; module procedure &
    map_ccc2xxx_mct
  end interface
...
!--------------------------------------------------------------------------
  ...
  character(*),parameter :: subName = '(map_{ccc}{ccc}_mct)'
...
!</list>
    ...
    ! Local Variables
    !
    character(len=*),parameter :: subname = "(map_{ccc}2{ccc}_init_mct) "
...
!=======================================================================
  ...
  subroutine map_ccc2xxx_mct( cdata_cc, av_cc, cdata_cx, av_cx, fldlist )
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_{ccc}2{ccc}x_mct) "
...
!=======================================================================
  ...
  subroutine map_xxx2ccc_mct( cdata_cx, av_cx, cdata_cc, av_cc, fldlist)
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_{ccc}x2{ccc}{c}_mct) "
