...
integer :: index_a2x_Sa_zinteger :: index_a2x_Sa_uinteger :: index_a2x_Sa_vinteger :: index_a2x_Sa_tbotinteger :: index_a2x_Sa_pteminteger :: index_a2x_Sa_shuminteger :: index_a2x_Sa_densinteger :: index_a2x_Sa_pbotinteger :: index_a2x_Sa_pslvinteger :: index_a2x_Faxa_lwdninteger :: index_a2x_Faxa_raincinteger :: index_a2x_Faxa_rainlinteger :: index_a2x_Faxa_snowcinteger :: index_a2x_Faxa_snowlinteger :: index_a2x_Faxa_swndrinteger :: index_a2x_Faxa_swvdrinteger :: index_a2x_Faxa_swndfinteger :: index_a2x_Faxa_swvdfinteger :: index_a2x_Faxa_swnetinteger :: index_a2x_Faxa_bcphidryinteger :: index_a2x_Faxa_bcphodryinteger :: index_a2x_Faxa_bcphiwetinteger :: index_a2x_Faxa_ocphidryinteger :: index_a2x_Faxa_ocphodryinteger :: index_a2x_Faxa_ocphiwetinteger :: index_a2x_Faxa_dstwet1integer :: index_a2x_Faxa_dstwet2integer :: index_a2x_Faxa_dstwet3integer :: index_a2x_Faxa_dstwet4integer :: index_a2x_Faxa_dstdry1integer :: index_a2x_Faxa_dstdry2integer :: index_a2x_Faxa_dstdry3integer :: index_a2x_Faxa_dstdry4integer :: index_a2x_Sa_co2proginteger :: index_a2x_Sa_co2diag
integer :: index_x2a_Sx_tinteger :: index_x2a_So_tinteger :: index_x2a_Sa_lfracinteger :: index_x2a_Sa_ifracinteger :: index_x2a_Sa_ofracinteger :: index_x2a_Sx_trefinteger :: index_x2a_Sx_qrefinteger :: index_x2a_Sx_avsdrinteger :: index_x2a_Sx_anidrinteger :: index_x2a_Sx_avsdfinteger :: index_x2a_Sx_anidfinteger :: index_x2a_Sl_snowhinteger :: index_x2a_Si_snowhinteger :: index_x2a_Sl_fvinteger :: index_x2a_Sl_ram1integer :: index_x2a_Faxx_tauxinteger :: index_x2a_Faxx_tauyinteger :: index_x2a_Faxx_latinteger :: index_x2a_Faxx_seninteger :: index_x2a_Faxx_lwupinteger :: index_x2a_Faxx_evapinteger :: index_x2a_Fall_flxdst1integer :: index_x2a_Fall_flxdst2integer :: index_x2a_Fall_flxdst3integer :: index_x2a_Fall_flxdst4integer :: index_x2a_Faxx_flxvoc1integer :: index_x2a_Faxx_flxvoc2integer :: index_x2a_Faxx_flxvoc3integer :: index_x2a_Faxx_flxvoc4integer :: index_x2a_Faxx_flxvoc5integer :: index_x2a_So_ustarinteger :: index_x2a_So_reinteger :: index_x2a_So_ssqinteger :: index_x2a_Sx_ddvelinteger :: index_x2a_Sx_u10integer :: index_x2a_Faxx_fco2_lndinteger :: index_x2a_Faxx_fco2_ocninteger :: index_x2a_Faxx_fdms_ocn
contains


  subroutine {ccc}_cpl_indices_set( )

    type(mct_aVect) :: c2x      ! temporary
    type(mct_aVect) :: x2c      ! temporary
!wangty modify
#ifdef wrf
...
!-----------------------------------------------------------------------------------------------------------
    ...
    call mct_aVect_init(x2c, rList=seq_flds_x2c_fields, lsize=1)
    call mct_aVect_init(c2x, rList=seq_flds_c2x_fields, lsize=1)


index_a2x_Sa_z = mct_avect_indexra(a2x,'Sa_z')index_a2x_Sa_u = mct_avect_indexra(a2x,'Sa_u')index_a2x_Sa_v = mct_avect_indexra(a2x,'Sa_v')index_a2x_Sa_tbot = mct_avect_indexra(a2x,'Sa_tbot')index_a2x_Sa_ptem = mct_avect_indexra(a2x,'Sa_ptem')index_a2x_Sa_shum = mct_avect_indexra(a2x,'Sa_shum')index_a2x_Sa_dens = mct_avect_indexra(a2x,'Sa_dens')index_a2x_Sa_pbot = mct_avect_indexra(a2x,'Sa_pbot')index_a2x_Sa_pslv = mct_avect_indexra(a2x,'Sa_pslv')index_a2x_Faxa_lwdn = mct_avect_indexra(a2x,'Faxa_lwdn')index_a2x_Faxa_rainc = mct_avect_indexra(a2x,'Faxa_rainc')index_a2x_Faxa_rainl = mct_avect_indexra(a2x,'Faxa_rainl')index_a2x_Faxa_snowc = mct_avect_indexra(a2x,'Faxa_snowc')index_a2x_Faxa_snowl = mct_avect_indexra(a2x,'Faxa_snowl')index_a2x_Faxa_swndr = mct_avect_indexra(a2x,'Faxa_swndr')index_a2x_Faxa_swvdr = mct_avect_indexra(a2x,'Faxa_swvdr')index_a2x_Faxa_swndf = mct_avect_indexra(a2x,'Faxa_swndf')index_a2x_Faxa_swvdf = mct_avect_indexra(a2x,'Faxa_swvdf')index_a2x_Faxa_swnet = mct_avect_indexra(a2x,'Faxa_swnet')index_a2x_Faxa_bcphidry = mct_avect_indexra(a2x,'Faxa_bcphidry')index_a2x_Faxa_bcphodry = mct_avect_indexra(a2x,'Faxa_bcphodry')index_a2x_Faxa_bcphiwet = mct_avect_indexra(a2x,'Faxa_bcphiwet')index_a2x_Faxa_ocphidry = mct_avect_indexra(a2x,'Faxa_ocphidry')index_a2x_Faxa_ocphodry = mct_avect_indexra(a2x,'Faxa_ocphodry')index_a2x_Faxa_ocphiwet = mct_avect_indexra(a2x,'Faxa_ocphiwet')index_a2x_Faxa_dstwet1 = mct_avect_indexra(a2x,'Faxa_dstwet1')index_a2x_Faxa_dstwet2 = mct_avect_indexra(a2x,'Faxa_dstwet2')index_a2x_Faxa_dstwet3 = mct_avect_indexra(a2x,'Faxa_dstwet3')index_a2x_Faxa_dstwet4 = mct_avect_indexra(a2x,'Faxa_dstwet4')index_a2x_Faxa_dstdry1 = mct_avect_indexra(a2x,'Faxa_dstdry1')index_a2x_Faxa_dstdry2 = mct_avect_indexra(a2x,'Faxa_dstdry2')index_a2x_Faxa_dstdry3 = mct_avect_indexra(a2x,'Faxa_dstdry3')index_a2x_Faxa_dstdry4 = mct_avect_indexra(a2x,'Faxa_dstdry4')index_a2x_Sa_co2prog = mct_avect_indexra(a2x,'Sa_co2prog')index_a2x_Sa_co2diag = mct_avect_indexra(a2x,'Sa_co2diag')!wangty modify
#ifdef wrf
...
index_x2a_Sx_t = mct_avect_indexra(x2a,'Sx_t')index_x2a_So_t = mct_avect_indexra(x2a,'So_t')index_x2a_Sa_lfrac = mct_avect_indexra(x2a,'Sa_lfrac')index_x2a_Sa_ifrac = mct_avect_indexra(x2a,'Sa_ifrac')index_x2a_Sa_ofrac = mct_avect_indexra(x2a,'Sa_ofrac')index_x2a_Sx_tref = mct_avect_indexra(x2a,'Sx_tref')index_x2a_Sx_qref = mct_avect_indexra(x2a,'Sx_qref')index_x2a_Sx_avsdr = mct_avect_indexra(x2a,'Sx_avsdr')index_x2a_Sx_anidr = mct_avect_indexra(x2a,'Sx_anidr')index_x2a_Sx_avsdf = mct_avect_indexra(x2a,'Sx_avsdf')index_x2a_Sx_anidf = mct_avect_indexra(x2a,'Sx_anidf')index_x2a_Sl_snowh = mct_avect_indexra(x2a,'Sl_snowh')index_x2a_Si_snowh = mct_avect_indexra(x2a,'Si_snowh')index_x2a_Sl_fv = mct_avect_indexra(x2a,'Sl_fv')index_x2a_Sl_ram1 = mct_avect_indexra(x2a,'Sl_ram1')index_x2a_Faxx_taux = mct_avect_indexra(x2a,'Faxx_taux')index_x2a_Faxx_tauy = mct_avect_indexra(x2a,'Faxx_tauy')index_x2a_Faxx_lat = mct_avect_indexra(x2a,'Faxx_lat')index_x2a_Faxx_sen = mct_avect_indexra(x2a,'Faxx_sen')index_x2a_Faxx_lwup = mct_avect_indexra(x2a,'Faxx_lwup')index_x2a_Faxx_evap = mct_avect_indexra(x2a,'Faxx_evap')index_x2a_Fall_flxdst1 = mct_avect_indexra(x2a,'Fall_flxdst1')index_x2a_Fall_flxdst2 = mct_avect_indexra(x2a,'Fall_flxdst2')index_x2a_Fall_flxdst3 = mct_avect_indexra(x2a,'Fall_flxdst3')index_x2a_Fall_flxdst4 = mct_avect_indexra(x2a,'Fall_flxdst4')index_x2a_Faxx_flxvoc1 = mct_avect_indexra(x2a,'Faxx_flxvoc1')index_x2a_Faxx_flxvoc2 = mct_avect_indexra(x2a,'Faxx_flxvoc2')index_x2a_Faxx_flxvoc3 = mct_avect_indexra(x2a,'Faxx_flxvoc3')index_x2a_Faxx_flxvoc4 = mct_avect_indexra(x2a,'Faxx_flxvoc4')index_x2a_Faxx_flxvoc5 = mct_avect_indexra(x2a,'Faxx_flxvoc5')index_x2a_So_ustar = mct_avect_indexra(x2a,'So_ustar')index_x2a_So_re = mct_avect_indexra(x2a,'So_re')index_x2a_So_ssq = mct_avect_indexra(x2a,'So_ssq')index_x2a_Sx_ddvel = mct_avect_indexra(x2a,'Sx_ddvel')index_x2a_Sx_u10 = mct_avect_indexra(x2a,'Sx_u10')index_x2a_Faxx_fco2_lnd = mct_avect_indexra(x2a,'Faxx_fco2_lnd')index_x2a_Faxx_fco2_ocn = mct_avect_indexra(x2a,'Faxx_fco2_ocn')index_x2a_Faxx_fdms_ocn = mct_avect_indexra(x2a,'Faxx_fdms_ocn')    index_a2x_Sa_co2prog    = mct_avect_indexra(a2x,'Sa_co2prog',perrWith='quiet')
