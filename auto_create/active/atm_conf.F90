...
[end domain_local_var]
[start 19_mct_aVect_zero]
    allocate(data(lsize))
[end 19_mct_aVect_zero]\
[start 20_domain_computing]
    data(:) = 1.0_R8
...
[end 20_domain_computing]
[start 21_other_function]
