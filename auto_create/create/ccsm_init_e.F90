subroutine ccsm_init()
 ...
 106  format( A, f23.12)
   ...
   call seq_cdata_init(cdata_wx, CPLID, dom_wx, gsMap_wx, infodata,'cdata_wx' ) 
   call seq_cdata_init(cdata_mx, CPLID, dom_mx, gsMap_mx, infodata,'cdata_mx' ) 
   call seq_cdata_init(cdata_cx, CPLID, dom_cx, gsMap_cx, infodata,'cdata_cx' )  
   call seq_cdata_init(cdata_gex, CPLID, dom_gex, gsMap_gex, infodata,'cdata_gex' )  
   call seq_cdata_init(cdata_cax, CPLID, dom_cax, gsMap_cax, infodata,'cdata_cax' ) 
